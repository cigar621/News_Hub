...
app.layout = html.Div([
        html.H1(id='title', children='News Hub', style={'margin-top':'75px','textAlign':'center','font-family':'Comic Sans MS'}),
        html.Br(),
...
def search_results(n_clicks,source,keyword):
    if keyword==None or source=='Top Headlines' or source==None:
